...
#if defined(NDEBUG)
#error "Caluracoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ucaluracoin) are considered zero fee (for relaying and mining)
...
{
    RenameThread("caluracoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // CLRC: We use certain sporks during IBD, so check to see if they are
