...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Caluracoin Core caluracoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  caluracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded caluracoin transaction") + "\n" +
                               "  caluracoin-tx [options] -create [commands]   " + _("Create hex-encoded caluracoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded caluracoin transaction
