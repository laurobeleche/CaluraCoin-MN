                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Caluracoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CLRC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and caluracoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Caluracoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Caluracoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Caluracoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CLRC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CLRC addresses"));
    ...
    openAction->setStatusTip(tr("Open a caluracoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Caluracoin Core help message to get a list with possible Caluracoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Caluracoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Caluracoin Core"); // default title
