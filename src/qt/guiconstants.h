...
/* Caluracoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Caluracoin"
#define QAPP_ORG_DOMAIN "caluracoincoin.io"
#define QAPP_APP_NAME_DEFAULT "Caluracoin-Qt"
#define QAPP_APP_NAME_TESTNET "Caluracoin-Qt-testnet"
