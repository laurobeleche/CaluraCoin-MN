...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Caluracoin Core"),
     ...
     * override -datadir in the caluracoin.conf file in the default data directory
     * (to be consistent with caluracoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
