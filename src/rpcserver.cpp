...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Caluracoin features */
        {"caluracoin", "masternode", &masternode, true, true, false},
        {"caluracoin", "listmasternodes", &listmasternodes, true, true, false},
        {"caluracoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"caluracoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"caluracoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"caluracoin", "masternodedebug", &masternodedebug, true, true, false},
        {"caluracoin", "startmasternode", &startmasternode, true, true, false},
        {"caluracoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"caluracoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"caluracoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"caluracoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"caluracoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"caluracoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"caluracoin", "mnbudget", &mnbudget, true, true, false},
        {"caluracoin", "preparebudget", &preparebudget, true, true, false},
        {"caluracoin", "submitbudget", &submitbudget, true, true, false},
        {"caluracoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"caluracoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"caluracoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"caluracoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"caluracoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"caluracoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"caluracoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"caluracoin", "checkbudgets", &checkbudgets, true, true, false},
        {"caluracoin", "mnsync", &mnsync, true, true, false},
        {"caluracoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> caluracoin-cli " + methodname + " " + args + "\n";
}
