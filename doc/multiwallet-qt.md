...
In order to support loading of multiple wallets in caluracoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is caluracoin.cpp.
...
Changes to caluracoin.cpp
----------------------
caluracoin.cpp is the entry point into caluracoin-qt, and as such, will require some minor modifications to provide hooks for
