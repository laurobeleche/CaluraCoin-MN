...
#   c) node1 mines 32 blocks, so now node 0 has 500000CLRC, node 1 has 4250CLRC, node2 has none.
#   d) node0 sends 601 CLRC to node2, in two transactions (301 CLRC, then 300 CLRC).
