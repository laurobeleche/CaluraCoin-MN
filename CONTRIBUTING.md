Contributing to Caluracoin Core
==================================

The Caluracoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Caluracoin Core project, and is not to be
confused with overall Caluracoin Network Protocol consensus changes.

Whether a pull request is merged into Caluracoin Core rests with the project merge
...
Patches that change Caluracoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Caluracoin consensus, it must have been
...
The project leader is the release manager for each Caluracoin Core release.
