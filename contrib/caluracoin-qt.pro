...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/caluracoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/caluracoin-cli.cpp \
           src/caluracoin-tx.cpp \
           src/caluracoin.cpp \
           src/db.cpp \
           ...
           src/qt/caluracoin.cpp \
           src/qt/caluracoinstrings.cpp \
...
RESOURCES += src/qt/caluracoin.qrc src/qt/caluracoin_locale.qrc

TRANSLATIONS += src/qt/locale/caluracoin_bg.ts \
                src/qt/locale/caluracoin_de.ts \
                src/qt/locale/caluracoin_en.ts \
                src/qt/locale/caluracoin_es.ts \
                src/qt/locale/caluracoin_fi.ts \
                src/qt/locale/caluracoin_fr.ts \
                src/qt/locale/caluracoin_it.ts \
                src/qt/locale/caluracoin_ja.ts \
                src/qt/locale/caluracoin_pl.ts \
                src/qt/locale/caluracoin_pt.ts \
                src/qt/locale/caluracoin_ru.ts \
                src/qt/locale/caluracoin_sk.ts \
                src/qt/locale/caluracoin_sv.ts \
                src/qt/locale/caluracoin_vi.ts \
                src/qt/locale/caluracoin_zh_CN.ts \
                src/qt/locale/caluracoin_zh_TW.ts
